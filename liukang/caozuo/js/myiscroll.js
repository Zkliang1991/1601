...
function getlistData(data){
	$.each(data, function(n, value) {
		...
		console.log(imgList)
		$('#thelist').append("<li><div class='pic'><a href='#'><img src="+imgList+" alt=''></a></div><div class='txt'><p><span>"+shopname+"</span><span>"+shopname+"</span></p><div class='det'><div class='price'><span>￥"+nprice+"</span><span>￥"+price+"</span><span>"+discount+"折</span></div><div class='buycar iconfont'>&#xe62d;</div></div></div></li>")
	})
	myScroll.refresh();
}
