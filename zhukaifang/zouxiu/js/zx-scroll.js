...
function listData(data){
	...
	$('#thelist').append("<li class='active'><dl  class='goods-list'><dt><img src="+Img+"></dt><dd><p>"+Goodsname+"</p><span class='price'><b>￥"+Price+"</b><i>￥</i><p>"+Discount+"折</p></span><span class='list-cart iconfont'>&#xe612;</span></dd></dl></li>");
}
	myScroll.refresh();	
}
